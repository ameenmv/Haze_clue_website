export default {
  ...
  reports: {
    ...
    whatYouGet: {
      ...
      attentionTrends: {
        ...
        description: 'تصور كيف يتقلب انتباه الفصل طوال الجلسة مع رسوم بيانية تفاعلية'
      },
      studentPerformance: {
        title: 'أداء الطلاب',
        description: 'تتبع مقاييس انتباه الفرد والمجموعة مع تحليلات تفصيلية'
      },
      insights: {
        title: 'رؤى وتوصيات',
        description: 'احصل على اقتراحات مدعومة بالذكاء الاصطناعي لتحسين التفاعل وأداء الفصل'
      },
      sessionTimeline: {
        title: 'الجدول الزمني للجلسة',
        description: 'راجع جدولاً زمنياً مفصلاً لمستويات الانتباه واللحظات الرئيسية خلال الفصل'
      }
    },
    myReports: 'تقاريري',
    refresh: 'تحديث',
  ...
  sessions: {
    ...
    tips: {
      title: 'نصائح للبدء',
      tip1: 'ابدأ بقالب جلسة يطابق مادتك',
      tip2: 'تأكد من توصيل جميع أجهزة مستشعر الدماغ (EEG) قبل البدء',
      tip3: 'راقب مستويات الانتباه في الوقت الفعلي أثناء الجلسة',
  ...
  liveSession: {
    ...
    timeline: {
      ...
      subtitle: 'يُظهر الرسم البياني متوسط انتباه الفصل الجماعي بمرور الوقت',
      last30: 'آخر 30 دقيقة',
      exportData: 'تصدير البيانات'
    },
    connectEeg: 'توصيل جهاز مستشعر الدماغ (EEG)',
    disconnect: 'قطع الاتصال'
  },
  notifications: {
    title: 'الإشعارات',
    markAllRead: 'تحديد الكل كمقروء',
    noNew: 'ليس لديك أي إشعارات جديدة حالياً.',
  ...
  liveSessionInfo: {
    mathClass: 'حصة الرياضيات - الصف العاشر',
    subject: 'الرياضيات'
  },
  liveSessionPanels: {
    '2secAgo': 'منذ ثانيتين'
