...
const stats = [
  { value: 0, suffix: '', label: t('landing.stats.users'), icon: 'i-ph-users-duotone', color: 'text-primary-500', bg: 'from-primary-500/10 to-primary-500/5' },
  { value: 0, suffix: '%', label: t('landing.stats.accuracy'), icon: 'i-ph-target-duotone', color: 'text-emerald-500', bg: 'from-emerald-500/10 to-emerald-500/5' },
  { value: 0, suffix: '', label: t('landing.stats.sessions'), icon: 'i-ph-brain-duotone', color: 'text-cyan-500', bg: 'from-cyan-500/10 to-cyan-500/5' },
  { value: 0, suffix: '/5', label: t('landing.stats.rating'), icon: 'i-ph-star-duotone', color: 'text-amber-500', bg: 'from-amber-500/10 to-amber-500/5' }
]
